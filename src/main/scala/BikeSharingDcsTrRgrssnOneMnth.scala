...
object BikeSharingDcsTrRgrssnOneMnth {
...
//May 5:
//RMSE of the training set is: 83.82023693088206
//RMSE of the test set obtained by using the model produced with the training set: 83.3958298216394
//R-Squared(R2) of the test set obtained by using the model produced with the training set: 0.7899274867190431