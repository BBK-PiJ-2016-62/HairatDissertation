...
object BikeSharingLnrRgrssnWhlYr {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data0 = data00.map(row=>(rerangeMnthAccordToCnt1(row._1)(sortMnthList), row._2, rerangeHrsAccordToCnt1(row._3)(sortHrList), row._4,
      rerangewthrAccordToCnt1(row._5)(sortWthrList), rerangeAtempAccordToCnt1(row._7)(sortAtempList),
      rerangeHumAccordToCnt1(row._8)(sortHumList), rerangeWndSpAccordToCnt1(row._9)(sortWindSpList), row._9))
