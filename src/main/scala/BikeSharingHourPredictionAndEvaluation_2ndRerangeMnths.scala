...
object BikeSharingHourPredictionAndEvaluation_2ndRerangeMnths {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data0 = dataRDDNoHeader.map(line => {
      val arr = line.split(",")
      (arr(2).toDouble, arr(3).toDouble, rerangeMnthsAccordToCnt(arr(4)), rerangeHrsAccordToCnt(arr(5)),
  ...
  def rerangeMnthsAccordToCnt(mnth: String): Double = {
    ...
    val rerangedDblMnth = mnth.toInt match { case 9 => 12.0; case 6 => 11.0; case 8 => 10.0; case 7 => 9.0;
                      ...
                      case 12 => 3.0; case 2 => 2.0; case 1 => 1.0
    }
    rerangedDblMnth
  }
}
